...
#define new block
def block_2ConvPool( name, botton, top, s_filer='', n_filer='', offset="(1,0,0)", size=(32,32,3.5), opacity=0.5 ):
    return [
    to_ConvConvRelu( 
...
def block_Unconv( name, botton, top, s_filer='', n_filer='', offset="(1,0,0)", size=(32,32,3.5), opacity=0.5 ):
    return [
...
def block_Res( num, name, botton, top, s_filer='', n_filer='', offset="(0,0,0)", size=(32,32,3.5), opacity=0.5 ):
    lys = []
